...
public class Withdrawal {
   ...
   Alert alert;
   Input input;
    public Withdrawal(Test test,Stage stage,Scene wscene) {
...
submit.setOnAction(e->{
 ...
 if (y>=x){
     test.history(bar.getText(), "Withdrawl");
 int z=y-x;
 test.setBalance(z);
 ...
 alert.setAlertType(Alert.AlertType.ERROR);
 alert.setContentText("your balance is smaller than this value\n "
         + "please make sure that you have enough money");
    alert.show();}
    }
});
